 ...
 */
class FieldTime extends Blockly.FieldTextInput {
    /**
     ...
     * @returns {!FieldTime} The new field instance.
     * @package
     * @nocollapse
     */
    ...
    bindInputEvents_(htmlInput) {
        ...
        this.onClickWrapper_ = Blockly.browserEvents.conditionalBind(htmlInput, 'click', this, this.onClick_, true);
    }
 ...
 * @type {boolean}
 */
FieldTime.prototype.SERIALIZABLE = true;

/**
 * Mouse cursor style when over the hotspot that initiates the editor.
 */
FieldTime.prototype.CURSOR = 'text';
 ...
 * @private
 */
FieldTime.prototype.DROPDOWN_BORDER_COLOUR = 'silver';
 ...
 * @private
 */
FieldTime.prototype.DROPDOWN_BACKGROUND_COLOUR = 'white';
 ...
 * @protected
 */
FieldTime.prototype.DEFAULT_VALUE = new goog.date.Date().toIsoString(true);
...
Blockly.fieldRegistry.register('field_date', FieldTime);
